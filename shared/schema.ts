...
export const companyApplications = pgTable("company_applications", {
  ...
  status: varchar("status", { length: 50 }).default("draft"), // draft, names_submitted, names_reviewed, pending_verification, submitted, under_review, clarification_requested, filed, pending_originals, courier_in_transit, completed, rejected
...
export const documentFiles = pgTable("document_files", {
  ...
  shareWithLawyer: boolean("share_with_lawyer"),
